...
class Parser
{
	...
	private:
		...
		luint imm;
		wxString opstring;
		map<Symbol, int> opcodes;
		map<Symbol, wxString> opstrings;
		map<Symbol, int> functcodes;
		luint address;
		map<luint, luint> instructions;
		map<luint, instruction> formattedInstructions;
		map<luint, Symbol> instructionSymbols;
		map<luint, luint> initialMemData;
		wxString fileContents;
		map<int, ParseError> errors;
		map<ParseError, wxString> errorStrings;
